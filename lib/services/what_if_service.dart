...
class WhatIfService {
  static Future<CashflowForecast> simulate({
    int days = 90,
    double incomeDelta = 0,
    double expenseDelta = 0,
    double recurringDelta = 0,
  }) async {
    ...
    for (int i = 1; i <= days; i++) {
      ...
      running += adjustedDailyIncome - adjustedDailyExpense + recurringNet;
    ...
    return CashflowForecast(
      ...
      dailyIncome: adjustedDailyIncome,
      dailyExpense: adjustedDailyExpense,
      forecast: forecast,
